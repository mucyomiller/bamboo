...
<!--  Logo section -->
<a href="#home"  class="brand-logo"><img src="img/small-logo.png" width="124" alt=" "></a>
<!--  // Logo section -->
<!--  Menu section -->
<nav class="main-nav">
<a href="#" class="nav-toggle"></a>
<ul id="sub-nav" class="nav right">
<li><a href="{{ route('frontend.index') }}" class="selected">Home</a></li>
<li><a href="{{ route('frontend.menu') }}">Menu <i class="pull-right fa fa-angle-down direction"></i></a>
<ul>
<li><a href="menu.html">Menus</a></li>
</ul>
</li>
<li><a href="{{ route('frontend.reservation') }}">Reservation</a></li>
